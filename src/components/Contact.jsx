          ...
          <div className="lg:col-span-5 flex flex-col gap-8 reveal reveal-right delay-200 text-left">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-4 items-start bg-stone-50 dark:bg-[#111827]/40 border border-stone-200 dark:border-stone-850 p-5 rounded-2xl premium-card-hover">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-sm text-stone-600 dark:text-stone-400 mt-1 leading-relaxed whitespace-pre-line">
                    {data.address}
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                ...
                <a href={`tel:${data.phone.replace(/\s+/g, '')}`} className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border font-bold text-xs transition-colors duration-300 border-brandGreen-600 text-brandGreen-700 hover:bg-brandGreen-600 hover:text-white dark:border-[#0df58b] dark:text-[#0df58b] dark:hover:bg-[#0df58b] dark:hover:text-stone-950">
                  <Phone size={14} className="stroke-[2.5]" />
                  <span>{language === 'vi' ? 'Gọi ngay' : 'Call now'}</span>
                </a>
              </div>
            </div>
